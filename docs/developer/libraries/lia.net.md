...
<summary><span class="summary-main"><a id="lia.net.profiler.log"></a>lia.net.profiler.log(direction, messageName, size, sender, receiver)</span><a class="source-link-button source-link-button--summary" href="https://github.com/LiliaFramework/Lilia/blob/main/gamemode/core/libraries/net.lua#L680" target="_blank" rel="noopener noreferrer" onclick="event.stopPropagation()">View Source</a></summary>
<div class="details-content">
